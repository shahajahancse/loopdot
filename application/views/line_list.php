...
<body style="background-color:#FCE9D9;">
    ...
    <div class="container" style="padding-top: 10px;">
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('index.php/crud_con/line_add')?>">Add Line</a>
              </div>
      ...
      <div class="row">
          <div class="col-md-12">
              <div class="col-md-6"><h3 style="margin-top: 0px; margin-bottom: 8px;">Line List</h3></div>
