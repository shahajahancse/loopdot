...
<!-- Static navbar -->
      <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand"href="<?php echo base_url('index.php/setup_con/designation')?>">Back To List</a>
          </div>
  ...
  <hr>
  <form enctype="multipart/form-data" method="post" name="creatdesignation" action="<?php echo base_url().'index.php/crud_con/desig_add'?>">
	  <div class="row">
	    <div class="col-md-6">
