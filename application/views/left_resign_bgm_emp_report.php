...
DETAILS INFORMATION AND LEFTY AND RESIGN EMPLOYEES LIST OF THE FACTORY FOR GROUP INSURANCE</br>
<?php 
...
<?php
	...
	?>
			...
			<table width="100%" height="80px" border="0" align="center" style="margin-bottom:120px; font-family:Arial, Helvetica, sans-serif; font-size:10px;">
			<tr height="80%" >
			<td colspan="28"></td>
			</tr>
			<tr height="20%">
