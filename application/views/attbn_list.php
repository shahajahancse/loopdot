...
<body style="background-color:#FCE9D9;">
    ...
    <div class="container" style="padding-top: 10px;">
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url('index.php/crud_con/attbn_add')?>">Add AttendanceBonus</a>
              </div>
      ...
      <div class="row">
          <div class="col-md-8">
              <div class="col-md-6"><h3 style="margin-top: 0px; margin-bottom: 8px;">AttendanceBonus List</h3></div>
