            ...
            <div align="center" style=" margin:0 auto; overflow:hidden; font-family: 'Times New Roman', Times, serif;">
                ...
                <table class="sal" border="1" cellpadding="0" cellspacing="0" align="center" style="font-size:10px; text-align-last: center;">
                    <tr>
                        ...
                        <th>TTl Payable Amount (With Stamp)</th>
                    </tr>
                    ...
                    ?>
                        <tr style="background-color: #cccfff;font-weight: bolder;">
                            ...
                            <td colspan="18" style="text-align: center; font-weight: bold;background-color: #fff;height: 70px;font-size: 13px;">
                            </td>
                            <?php } ?>
                        </tr>
                            ...
                            <?php //if($floor_arr['floor_name']=='none') { ?>
                            <td colspan="18" style="text-align: center; font-weight: bold;background-color: #fff;height: 100px;font-size: 13px;">
                    ...
                    <tr style="background-color: #cccfff;font-weight: bolder;">
                        <td colspan="18" style="text-align-last: left; font-weight: bold;background-color: #cccfff;">
                        ...
                        <tr>
                            ...
                            <td><?php echo $val['line_info']['total_net_pay_with_stamp'];?></td>
