              ...
              <ul class="sub-menu">
                ...
                <li class="start"> <a href="javascript:;"><span class="title">Setup</span> <span class="selected"></span> <span class="arrow"></span> </a>
                  <ul class="sub-menu">
                    ...
                    <li class="start "> <a href="<?=base_url()?>index.php/setup_con/job_desc" target="body_load">Job Description</a> </li>
                    <li class="start "> <a href="<?=base_url()?>index.php/setup_con/nid_wk_typ" target="body_load">Working Type</a> </li>
...
<div class="page-content">
    ...
    <div class="content">
      <div id="container" style="margin-bottom: 100px;">
        <iframe id="idIframe" width="100%" src="<?= base_url()?>index.php/emp_info_con/at_a_glance_info_view" name="body_load" style="border:0px solid;" scrolling="no" onload="iframeLoaded()"></iframe>
      </div>
    </div>
  </div></div>
<!-- END CONTAINER -->
