...
foreach($values as $rows)
{
 ...
 $this->load->view('head_bangla'); ?>
			...
			<td width="75">
				...
				<font style="font-family: SutonnyMJ;font-size:14px;">: 
					<?php 
						...
						//$w_h_ot = $rows["w_h_ot"];
						$w_h_ot_amt = round($w_h_ot * $rows["ot_rate"]);
						$Tot_hour = $ot_hour - $w_h_ot;
						echo $total_days = $Tot_hour; 
					?> 
				</font>
			</td>
		</tr>
  ...
  <!-- <table width="236" style="font-size: 11px;">
  	<tr>
  	  	<td width="152"> অগ্রীম দণ্ড </td>
  	  	<td >:</td>
  		<td width="59" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $total_days = $rows["due_pay_add"];   ?> </font></td>
  	</tr>
  </table> -->
   ...
   <div style="border-bottom:1px solid #000000; line-height: 25px;">
    ...
    <tr>
	  ...
	  <td width="45" style="padding-right: 12px;" align="right">
	  	...
	  	?> 
	  	<span style="font-family: SutonnyMJ; font-size:14px;" > <?php echo $total_days = $ot_amount - $w_h_ot_amt;?> </span>
	  </td>
    </tr></table></div>
    ...
    <tr>
      ...
      <td >:</td>
	  <td width="78" style="padding-right: 9px;" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $total_days = $net_pay + $due_pay_add - $w_h_ot_amt;?> </font></td>
    </tr></table></div>
  </div>
