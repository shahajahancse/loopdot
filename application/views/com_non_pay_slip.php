  ...
  <div style="width:312px; margin-top:12px; line-height: 14px; height:auto; overflow:hidden; border:1px solid #000000;">
	...
	<table width="300" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="75"><font style="font-family: SutonnyMJ; font-size:14px;">: <?php echo $total_days = $rows["ot_hour"] + $rows["eot_hour"];   ?> </font> </td>
		</tr>
		<tr>
...
<!----------------->  
   <div style="border-bottom:1px solid #000000; line-height: 25px;"><table width="295" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  <span style="font-family: SutonnyMJ; font-size:14px;" > <?php echo $total_days = $rows["ot_amount"] + $rows["eot_amount"]; ?> </span>
	  </td>
    </tr></table></div>
    ...
    <tr>
      ...
      <td >:</td>
	  <td width="78" style="padding-right: 9px;" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $total_days = $rows["net_pay"];   ?> </font></td>
    </tr></table></div>
  </div>
  ...
  <div style="width:312px; height:auto; margin-top:12px; line-height: 14px; overflow:hidden; border:1px solid #000000;">
	...
	<table width="300" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="100">   <font style="font-family: SutonnyMJ; font-size:14px;">: <?php echo $total_days = $rows["weekend"];   ?> </font>  </td>
			<td width="72" style="font-size: 10px;">&#2451;&#2463;&#2495; &#2456;&#2472;&#2509;&#2463;&#2494; </td>
			<td width="75"><font style="font-family: SutonnyMJ; font-size:14px;">: <?php echo $total_days = $rows["ot_hour"];   ?> </font> </td>
		</tr>
		<tr>
			<td width="76" height="14" style="font-size: 10px;">&#2437;&#2472;&#2509;&#2479;&#2494;&#2472;&#2509;&#2479; &#2459;&#2497;&#2463;&#2495; 
		    </td>
   ...
   <div style="border-bottom:1px solid #000000; line-height: 25px;"><table width="295" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="210"><span style="position:relative; left:5px; font-weight:bold;"> (ঘ) অতিরিক্ত কাজ </span></td>
	   <td >:</td>
	  <td width="45" style="padding-right: 12px;" align="right"> 
	  <span style="font-family: SutonnyMJ; font-size:14px;" > <?php echo $total_days = $rows["ot_amount"];   ?> </span>
	  </td>
    </tr></table></div>
