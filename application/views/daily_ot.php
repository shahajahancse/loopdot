...
<table class="heading" align="center" height="auto" style="font-size:12px; width:750px;border:0px;;">
	<tr height="70px">
		...
		<?php $this->load->view("head_english");?> <span style="font-size:13px; font-weight:bold; text-align: center;">
			Daily OT Report of <?php echo "$start_date"; ?>
			</span>
		</td>
...
<th>SL</th><th>Emp ID</th><th>Employee Name</th> <!--<th>DOJ</th>--> <th>Department</th>  <th>Line No. </th> <th>Designation</th><th>Gross</th> <th>OT Rate</th> <th>IN Time</th> <th>Out Time</th> <th>OT Hour</th><th>OT Amt</th>
...
<?php
	...
	for($i=0; $i<=$per_page_id; $i++)
	{
		if($section!=$values["sec_name"][$k]){
			...
			$sec_ot_hour = $sec_ot_hour + $ot_hour;
			$total_ot_hour = $total_ot_hour + $ot_hour;
			echo "<td  style='text-align:center;' >";
			echo $ot_hour;
			echo "</td>";
			
			$ot_amount = $values["ot_amount"][$k];	
			$sec_ot_amount = $sec_ot_amount + $ot_amount;
