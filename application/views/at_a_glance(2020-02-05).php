...
.custom_loader {
    ...
    height: 100%;
    z-index: 9999;
    background-image: url(<?php echo base_url(); ?>images/ajax-loader1.gif);
...
.temp_daily_report,.temp_monthly_report,.last_month_expansive_report{
  margin-left:8px;
  width: 235px;
  height: 95px;
  padding: 2px 4px;
...
path.highcharts-button-symbol,text.highcharts-title,text.highcharts-credits{
  display: none;
}
...
rect.highcharts-button-box,g.highcharts-exporting-group{
  display: none;
}
...
<h3 style="text-align: center;background: #cccfff;margin: 3px 0px;">Dash Board Report OF <?php echo $report_date; ?></h3>
<div class="custom_loader" style="display: none;"></div>
  <div class="container">
	  <div class="row" >
      <?php
...
<div class="clearfix" style="display:none;">
    <div class="loading"><img src="<?php echo base_url() ?>images/ajax-loader1.gif"  alt="Load"/></div>
