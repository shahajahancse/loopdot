...
<table class="heading" align="center" height="auto" style="font-size:12px; width:750px;border:0px;">
	<tr height="70px">
		...
		<?php $this->load->view("head_english");?><span style="font-size:13px; font-weight:bold; text-align: center;">
			Daily Weekend Allowance Report of <?php echo "$start_date"; ?>
			</span>
		</td>
...
<?php
	...
	echo $values["weekend_allowance_amount"][$k];
	echo "</td>";
	
	$total_weekend_allo_amount = $total_weekend_allo_amount + $values["weekend_allowance_amount"][$k];
	echo "</tr>";
...
<?php if($counter == $page){ ?>
	<tr>
		...
		<td style="text-align:right; font-weight:bold;" ><?php echo number_format($total_weekend_allo_amount); ?>/=</td>
	</tr>
<?php } ?>
	<table width="750" height="65px" border="0" align="center" style="margin-bottom:70px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;">
        ...
        <td  align="left" style="width:10%;"><dt class="bottom_txt_design" >Checked By</dt></td>
        <td  align="left" style="width:20%;"><dt class="bottom_txt_design" >GM(Admin, HRD & Compliance)</dt></td>
        <td  align="left" style="width:12%" ><dt class="bottom_txt_design" >Approved By</dt></td>
		</tr>
	</table>
</table>
