...
for($i=0; $i<$count; $i++ )
{
	...
	echo "<td colspan='9' style='font-size:16px'>Section :".$values["sec_name"][$i]."</td>";
	echo "</tr>";
	
	 ?>
		
	<th>SL</th><th>Emp ID</th><th>Proxi ID</th><th>Name</th><th>Dept.</th><th>Section</th><th>Line</th><th>Designation</th><th>Total Late</th>
	<?php
