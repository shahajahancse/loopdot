	 ...
	 <div class="nodedocuments" id="documents1111" style="display: block; margin-left: 16px;">
      ...
      <div class="nodedocuments" id="documents10" style="display: block; margin-left: 16px;">
        ...
        <?php if(!in_array($user_id,$usr_arr_2)){  ?>
          <div class="nodeheader">
              <b id="name12" name="Reception ">
              </b>
              <img src="<?php echo base_url();?>/images/tree_image/utree_data/plus.gif" onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image12" onClick="SetNode('12');" border="0">
              <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage12" onDblClick="SetNode('12');">Dash Board
          </div>
        ...
        <div class="nodedocuments" id="documents32" style="display: none; Margin-left: 16;">
          ...
          <div class="document">
           ...
           <!--<div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/setup_con/unit" title="Unit" target="right" id="dp83" onClick="MakeColoredBack('83');">Unit</a>
          </div> --> 
      ...
      <?php
        ...
        <?php if(!in_array($user_id,$usr_arr_2)){  ?>
          ...
          <!-- <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/entry_system_con/shift_log_delete" title="Holiday" target="right" id="dp9988" onClick="MakeColoredBack('9988');">Log Data Delete</a>
          </div> -->
       ...
       <?php } ?>   
        ...
        <div class="nodedocuments" id="documents400" style="display: none; Margin-left: 16;">
          ...
          <!-- <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/attn_process_con/attn_file_upload" title="File Upload" target="right" id="dp5170" onClick="MakeColoredBack('5170');">File Upload</a>
          </div> -->
    ...
    <?php if(!in_array($user_id,$usr_arr)){  ?>
	  ...
	  <div class="nodedocuments" id="documents9000" style="display: block; margin-left: 16px;">
        <div class="nodeheader">
          ...
          <img src="<?php echo base_url();?>/images/tree_image/utree_data/closed.gif" id="nodeimage9001" onDblClick="SetNode('9001');">Salary Process</div>
