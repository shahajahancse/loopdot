	...
	<td style="width:400px; height:350px; padding: 3px 15px;" valign='top' align='center'>
		<div class="id_card_front" style="width:195px; height:312px; padding:1px; vertical-align: top; border-radius: 10px; border:1px solid black; float: left;">
		  	<div class="front_top" style="margin-top: 3px; float: left;">
				<div class="front_top_left" style="width:30px; float:left;">
					<img src="<?php  echo base_url();?>images/<?php echo $company_logo = $this->common_model->company_information("company_logo"); ?>" height="25px" width="25px" />
				</div>
				<div class="front_top_middle" style="width:160px; text-align:center; float:left; margin: 0 auto;vertical-align:top;line-height: 14px;">
					<div class="e_front_col_6" style="font-size:12px; padding:1px 16px 0px 0px;">
				   	...
				   	<div class="e_front_col_6" style="font-size:12px; padding:1px 22px 0px 0px;">
						<b><spam style="font-size: 12px; font-family: kalpurush;"><?php echo "ব্যান্ডো ফ্যাশনস লিঃ"; ?></spam></b>
			...
			<div class="front_top_left" style="width:100%; vertical-align:top; font-size: 20px;">
				<div style="width:100%;padding-right:5px;text-align:center;margin-top: 0px;font-size:12px;">
					<p style="margin: 0px; margin-top: 3px;line-height: 14px;font-family: kalpurush;font-size: 12px;"><?php echo $company_logo = $this->common_model->company_information("company_add_bangla"); ?></p>
					<p style="margin: 0px;  font-size:12px; font-family: kalpurush;">ফোন: <?php echo $company_logo = $this->common_model->company_information("company_phone"); ?></p>
				</div>
			...
			<div class="front_top_left" style="width:100%; vertical-align:top; font-size: 20px; padding-top: 1px; text-align-last: left;">
				<div class="front_row_left_3">
					<div class="e_front_col_6" style="line-height: 14px;font-size: 12px; margin: 5px;font-family: kalpurush;">১। নামঃ <b><?php echo $data[$i]["bangla_nam"]; ?></b></div>
				</div>
				<div class="front_row_left_1">
					<div class="e_front_col_1" style="line-height: 14px;font-size: 12px; margin: 5px;font-family: kalpurush;">২। কার্ড নংঃ <b><span style="font-family: SutonnyMJ; "><?php echo $data[$i]["emp_id"] ?></span></b></div>
				</div>
			</div>
			<div class="front_row_2" style="text-align: left">
				<div class="e_front_col_8" style="line-height: 14px;font-size: 12px; margin: 2px;  text-align-last: left;font-family: kalpurush;">
					৩। পদবীঃ <b>
				   <?php 
			...
			<div class="front_row_3">
				<div class="e_front_col_12" style="line-height: 14px;font-size: 12px; margin: 2px;  text-align-last: left; font-family: kalpurush;">
			...
			<div class="front_row_3">
				<div class="e_front_col_12" style="line-height: 14px;font-size: 11px; margin: 2px;  text-align-last: left; font-family: kalpurush;">
					৬। কাজের ধরনঃ <b><?php echo $data[$i]["wk_type"]; ?></b></div>
			</div>

			<div class="front_row_4">
				<div class="e_front_col_13" style="font-size: 12px; line-height: 14px;margin: 2px; font-family: SutonnyMJ;  text-align-last: left;">
					৭। যোগদানের তাংঃ <b>
					<?php 
			...
			<div class="front_row_5" style="text-align:left;margin-top:2px;  width: 100%;">
				<div style=" float: left;  width: 50%;">
					<img src="<?php echo base_url();?>images/<?php echo $company_signature = $this->common_model->company_information("company_signature"); ?>" width="60" height="20" />
				</div>
			...
			<div class="front_row_7" style=" margin-top:1px; width: 100%;font-family: kalpurush;">
				<div class="e_front_col_19" style=" width: 47%; float:left; border-top:1px dotted black; font-size: 12px; margin: 1px;line-height: 14px;">কর্তৃপক্ষ স্বাক্ষর</div>
		...
		<div class="id_card_front" style="width:195px; height:312px; padding:1px; vertical-align: top; border-radius: 10px; border:1px solid black; float: right;line-height: 14px;">
			<div class="front_top_left" style="width:100%; vertical-align:top; font-size: 15px; padding-top: 5px;">
				...
				<div class="front_row_left_1">
					<div class="e_front_col_1" style="font-size: 12px; min-height: 40px; margin: 20px 0; font-family: kalpurush;"> স্থায়ী ঠিকানাঃ<b><?php echo $data[$i]["emp_par_add_ban"]; ?></b></div>
				</div>
			</div>
			<div class="front_row_2">
				<div class="e_front_col_8" style="font-size: 12px; min-height: 40px; margin: 5px 0; font-family: kalpurush;line-height: 14px;">
			...
			<br>
			<div class="front_top" style="float: left; width: 100%; margin: 0 auto;">
				...
				<div class="front_top_middle" style=" height: 20px; text-align:center; float:right; margin: 0;vertical-align:top; float: left; font-family: kalpurush; padding-top: 10px;">
					<b><spam style="font-size: 12px;line-height: 14px;"><?php echo "ব্যান্ডো ফ্যাশনস লিঃ"; ?></spam></b>
						
				</div>
			</div>
			<div class="front_top_left" style="width:100%; vertical-align:top; font-size: 20px;font-family: kalpurush;">
				<div style="width:100%;padding-right:5px;text-align:center;margin-top: 0px;font-size:12px;">
					<p style="margin: 0px; font-size: 12px;line-height: 14px;"><?php echo $company_logo = $this->common_model->company_information("company_add_bangla"); ?></p>
					<p style="margin: 0px;">ফোন: <?php echo $company_logo = $this->common_model->company_information("company_phone"); ?></p>
				</div>
			</div>
		</div>
	</td>
