...
<tr><td align='center'></td><td></td><td><input type='button' name='add' onclick='enable_leve()' value='NEW'/>&nbsp;<input type='button' name='leave_save' disabled='disabled' onclick='save_leave()' value='SAVE'/>&nbsp; <input type="button" style="width:100%; font-size:100%;" value="Leave Application" onClick="grid_leave_application_form()"></td></tr>
