...
<!-- <fieldset style='width:86%;'><legend><font size='+1'><b>Category Options</b></font></legend>
<table class="table">
<tr>
<td>Unit</td>
<td>:</td>
...
<!-- </tr>
    ...
    <div class="attendance-process">
        <fieldset style='width:88%;'><legend><font size='+1'><b>Salary Process</b></font></legend>

        <?php $this->load->view('month_year');
        $salary_process = "1";
        $final_salary_process = "2";
        ?>
        <input class="btn btn-primary" type='button' name='view' onclick='salary_process(<?php echo $salary_process; ?>)' value='Process'/>
        <input class="btn btn-primary" style="margin-left:10%" type='button' name='view' onclick='salary_process(<?php echo $final_salary_process; ?>)' value='Final Process'/>
        </fieldset>
    </div>
</form>
</div>
