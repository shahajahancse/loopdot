...
<fieldset style='width:605px;'><legend><font size='+1'><b>Festival Process</b></font></legend>
...
$festival_process = "1";
$final_festival_process = "2";
?>
<input class="btn btn-primary" type='button' name='view' onclick='festival_process(<?php echo $festival_process; ?>)' value='Process'/>
<input class="btn btn-primary" type='button' name='view' onclick='festival_process(<?php echo $final_festival_process; ?>)' value='Final Process'/>
</fieldset>

</div>
<div class="form-group" id="loader"  align="center" style="margin:0 auto; width:600px; overflow:hidden; display:none; margin-top:10px;"><img src="<?php echo base_url();?>/images/ajax-loader.gif" /></div>
