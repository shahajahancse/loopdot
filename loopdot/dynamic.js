...
function getBaseURL() {
	...
	return hostname.substring(0, (hostname.indexOf("index.php") == -1) ? hostname.length : hostname.indexOf("index.php"));
}
...
function empty_pi(){
	...
	document.getElementById('saldraw').value = "";
	document.getElementById('dept').value = "";
	document.getElementById('sec').value = "";
	document.getElementById('line').value = "";
	document.getElementById('desig').value = "";
	document.getElementById('empstat').value = "";
	document.getElementById('emp_floor').value = "";
	document.getElementById('bank_ac_no').value = "";
	document.getElementById('emp_sts_id').value = "";
	document.getElementById('salg').value = "";
	document.getElementById('otentitle').value = "";
	document.getElementById('empshift').value = "";
	document.getElementById('lunch').value = "";
	document.getElementById('transport').value = "";
	document.getElementById('ejd').value = "";
	document.getElementById('skill_process_one').value = "";
	document.getElementById('skill_process_two').value = "";
	document.getElementById('skill_process_three').value = "";
	document.getElementById('skill_process_four').value = "";
	document.getElementById('hour_one').value = "";
	document.getElementById('hour_two').value = "";
	document.getElementById('hour_three').value = "";
	document.getElementById('hour_four').value = "";
	document.getElementById('attbonus').value = "";
	document.getElementById('saltype').value = "";
...
function ajaxInsert(){
	...
	var units 	= document.getElementById('cominfo').units.value;
	var dept 	= document.getElementById('dept').value;
	var sec 	= document.getElementById('sec').value;
	var line 	= document.getElementById('line').value;
	var desig 	= document.getElementById('desig').value;
	var empstat = document.getElementById('empstat').value;
	var emp_floor = document.getElementById('emp_floor').value;
	...
	var skill_process_one = document.getElementById('skill_process_one').value;
	var skill_process_two = document.getElementById('skill_process_two').value;
	var skill_process_three = document.getElementById('skill_process_three').value;
	var skill_process_four = document.getElementById('skill_process_four').value;
	var hour_one = document.getElementById('hour_one').value;
	var hour_two = document.getElementById('hour_two').value;
	var hour_three = document.getElementById('hour_three').value;
	var hour_four = document.getElementById('hour_four').value;
	var attbonus = document.getElementById('attbonus').value;
	var saltype = document.getElementById('saltype').value;
	var text8 	= document.getElementById('gsal').value;
	var text9 	= document.getElementById('com_gsal').value;
	var text2 	= document.getElementById('emp_last_dg').value;
	var text3 	= document.getElementById('pass_year').value;
	// var text4 	= document.getElementById('edu_insti').value;
	var text5 	= document.getElementById('skill_dept').value;
	var text6 	= document.getElementById('skill_year').value;
	var text7 	= document.getElementById('skill_com_na').value;
	var position = document.getElementById('position').value;

	var img = document.getElementById('cominfo').userfile.value;
	
	var queryString = "empid="+empid+"&idcard="+idcard+"&name="+name+"&bname="+bname+"&mname="+mname+"&fname="+fname+"&sname="+sname+"&mobile_no="+mobile_no+"&padd="+padd+"&fadd="+fadd+"&dob="+dob+"&reli="+reli+"&sex="+sex+"&ms="+ms+"&bgroup="+bgroup+"&n_id="+n_id+"&units="+units+"&dept="+dept+"&sec="+sec+"&line="+line+"&desig="+desig+"&empstat="+empstat+"&emp_floor="+emp_floor+"&bank_ac_no="+bank_ac_no+"&emp_sts_id="+emp_sts_id+"&salg="+salg+"&otentitle="+otentitle+"&empshift="+empshift+"&lunch="+lunch+"&transport="+transport+"&ejd="+ejd+"&skill_process_one="+skill_process_one+"&skill_process_two="+skill_process_two+"&skill_process_three="+skill_process_three+"&skill_process_four="+skill_process_four+"&hour_one="+hour_one+"&hour_two="+hour_two+"&hour_three="+hour_three+"&hour_four="+hour_four+"&attbonus="+attbonus+"&saltype="+saltype+"&text8="+text8+"&text9="+text9+"&text2="+text2+"&text3="+text3+"&text5="+text5+"&text6="+text6+"&text7="+text7+"&position="+position;

	ajaxRequest.open("POST", getBaseURL() + "index.php/emp_info_con/per_info1/", true);
...
if(okyes==false) return;
 ...
 // server script.
	...
	ajaxRequest.open("POST", getBaseURL() + "index.php/emp_info_con/per_update1/", true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
ajaxRequest.onreadystatechange = function(){
   ...
   // document.getElementById('search_empid').value="";
	//document.getElementById('cominfo').save.disabled = false;
	//document.getElementById('cominfo').com_empid.focus();
	}
}
...
function com_info_insert(){
 ...
 var com_empid = document.getElementById("com_empid").value;
	...
	var queryString="com_empid="+com_empid+"&idcard="+idcard+"&dept="+dept+"&sec="+sec+"&line="+line+"&desig="+desig+"&operation="+operation+"&position="+position+"&salg="+salg+"&empstat="+empstat+"&empshift="+empshift+"&gsal="+gsal+"&com_gsal"+com_gsal+"&otentitle="+otentitle+"&transport="+transport+"&lunch="+lunch+"&attbonus="+attbonus+"&ejd="+ejd+"&saldraw="+saldraw+"&saltype="+saltype+"&skill_process_one="+skill_process_one+"&skill_process_two="+skill_process_two+"&skill_process_three="+skill_process_three+"&skill_process_four="+skill_process_four+"&hour_one="+hour_one+"&hour_two="+hour_two+"&hour_three="+hour_three+"&hour_four="+hour_four;
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		var resp = ajaxRequest.responseText;
		//document.getElementById('cominfo').dept.options.length=0;
		//empty_pi();
		alert(resp);
	}
}
...
function com_basic_sal_cal(){
   ...
   var date = d.getDate();
   var curDate = year + "-" + (("0" + month).slice(-2)) + "-" + (("0" + date).slice(-2));
   if(curDate > '2025-02-01'){
	var com_mallow      = 750;
	var com_trans_allow = 450;
	var com_lunch_allow = 1250;
   } else if(curDate > '2023-11-01' && curDate < '2025-02-01'){
	var com_mallow      = 750;
	var com_trans_allow = 450;
	var com_lunch_allow = 1250;
   }else{
	var com_mallow      = 600;
	var com_trans_allow = 350;
	var com_lunch_allow = 900;
   }
	...
	document.getElementById('com_mallow').value = com_mallow;
	document.getElementById('com_transport_allow').value = com_trans_allow;
	
	document.getElementById('com_lunch_allow').value = com_lunch_allow;

	var com_bsal = Math.round((com_gsal - (com_mallow + com_trans_allow + com_lunch_allow)) / 1.5);
	document.getElementById('com_bsal').value = com_bsal;
	// var com_hrent = Math.round(com_bsal * 0.5);
    var com_hrent = Math.round(com_gsal - (com_mallow + com_trans_allow + com_lunch_allow + com_bsal));
...
function com_info_next_Search1()
{
   ...
   var ajaxRequest;  // The variable that makes Ajax possible!
	...
	var url = getBaseURL() + "index.php/emp_info_con/com_info_next_Search1/";
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			document.getElementById('cominfo').pi_save.disabled = true;
			document.getElementById('cominfo').pi_edit.disabled = false;
			document.getElementById('cominfo').pi_delete.disabled = false;
			document.getElementById('cominfo').empstat.disabled = true;
			...
			//alert(otherinfo);
			//alert(otherinfo[1]);
		document.getElementById('empid').value = otherinfo[0];
		document.getElementById('padd').value = otherinfo[1];
		document.getElementById('fadd').value = otherinfo[2];
		document.getElementById('emp_last_dg').value = otherinfo[3];
		document.getElementById('pass_year').value = otherinfo[4];
		// document.getElementById('edu_insti').value = otherinfo[5]; // edu_insti commented out in view
		document.getElementById('skill_dept').value = otherinfo[6];
		document.getElementById('skill_year').value = otherinfo[7];
		document.getElementById('skill_com_na').value = otherinfo[8];
		document.getElementById('name').value = otherinfo[9];
		document.getElementById('fname').value = otherinfo[10];
		document.getElementById('mname').value = otherinfo[11];
		// fname_bn: 12, mname_bn: 13
		document.getElementById('dob').value = otherinfo[14];
		document.getElementById('reli').value = otherinfo[15];
		document.getElementById('sex').value = otherinfo[16];
		document.getElementById('ms').value = otherinfo[17];
		document.getElementById('bgroup').value = otherinfo[18];

		var img = otherinfo[19];
		hostname = window.location.href;
		hostname = hostname.substring(0, (hostname.indexOf("index.php") == -1) ? hostname.length : hostname.indexOf("index.php"));
		document.getElementById('img').src = hostname + "uploads/photo/" + img;
		document.getElementById('img').height = 150;
		document.getElementById('img').width = 120;

		document.getElementById('mobile_no').value = otherinfo[20];
		document.getElementById('bname').value = otherinfo[21];
		document.getElementById('id_skill').value = otherinfo[22];
		document.getElementById('sname').value = otherinfo[23];
		document.getElementById('n_id').value = otherinfo[24];
		document.getElementById('bank_ac_no').value = otherinfo[25];
			//document.getElementById('cominfo').search_empid.value = otherinfo[0];
			com_info = alldata[1].split("=*=");
			//alert(com_info);

			// Skill Process 1
			var skill_process_one = com_info[29];
			document.getElementById('skill_process_one').value = skill_process_one;

			// Skill Process 2
			var skill_process_two = com_info[30];
			document.getElementById('skill_process_two').value = skill_process_two;

			// Skill Process 3
			var skill_process_three = com_info[31];
			document.getElementById('skill_process_three').value = skill_process_three;

			// Skill Process 4
			var skill_process_four = com_info[32];
			document.getElementById('skill_process_four').value = skill_process_four;

			// Hour 1
			var hour_one = com_info[33];
			document.getElementById('hour_one').value = hour_one;

			// Hour 2
			var hour_two = com_info[34];
			document.getElementById('hour_two').value = hour_two;

			// Hour 3
			var hour_three = com_info[35];
			document.getElementById('hour_three').value = hour_three;

			// Hour 4
			var hour_four = com_info[36];
			document.getElementById('hour_four').value = hour_four;

			document.getElementById('cominfo').idcard.value = com_info[1];

			//document.getElementById('cominfo').section.value = com_info[];
			...
			//document.getElementById('cominfo').dept.options.length=0;
			//for (i=0; i<dept_id.length; i++){
			//	document.getElementById('cominfo').dept.options[i]=new Option(dept_name[i],dept_id[i], false, true);
			//	}
			...
			for (i=0; i<dept_id.length; i++){
				...
				document.getElementById('cominfo').dept.options[i]=new Option(dept_name[i],dept_id[i], false, false);
			}
			...
			document.getElementById('cominfo').sec.options.length=0;
			for (i=0; i<sec_id.length; i++){
				if( com_info[3] == sec_name[i])
				{
					document.getElementById('cominfo').sec.options[i]=new Option(sec_name[i],sec_id[i], false,true);
				}
				else
					document.getElementById('cominfo').sec.options[i]=new Option(sec_name[i],sec_id[i], false, false);
			...
			document.getElementById('cominfo').line.options.length=0;
			for (i=0; i<line_id.length; i++){
				if( com_info[4] == line_name[i])
				{
					//alert(line_name[i]);
					document.getElementById('cominfo').line.options[i]=new Option(line_name[i],line_id[i], false,true);
				}
				else
				//alert(line_name[i]);
				document.getElementById('cominfo').line.options[i]=new Option(line_name[i],line_id[i], false, false);
			...
			document.getElementById('cominfo').desig.options.length=0;
			for (i=0; i<desig_id.length; i++){
				if( com_info[5] == desig_name[i])
				{
					//alert(dept_name[i]);
					document.getElementById('cominfo').desig.options[i]=new Option(desig_name[i],desig_id[i], false,true);
				}
				else
				document.getElementById('cominfo').desig.options[i]=new Option(desig_name[i],desig_id[i], false, false);
			...
			document.getElementById('cominfo').operation.options.length=0;
			for (i=0; i<operation_id.length; i++){
				if( com_info[6] == operation_name[i])
				{
					//alert(dept_name[i]);
					document.getElementById('cominfo').operation.options[i]=new Option(operation_name[i],operation_id[i], false,true);
				}
				else
				document.getElementById('cominfo').operation.options[i]=new Option(operation_name[i],operation_id[i], false, false);
			...
			document.getElementById('cominfo').position.options.length=0;
			for (i=0; i<position_id.length; i++){
				if( com_info[7] == position_name[i])
				{
					//alert(dept_name[i]);
					document.getElementById('cominfo').position.options[i]=new Option(position_name[i],position_id[i], false,true);
				}
				else
				document.getElementById('cominfo').position.options[i]=new Option(position_name[i],position_id[i], false, false);
			...
			document.getElementById('cominfo').salg.options.length=0;
			for (i=0; i<salg_id.length; i++){
				if( com_info[8] == salg_name[i])
				{
					//alert(dept_name[i]);
					document.getElementById('cominfo').salg.options[i]=new Option(salg_name[i],salg_id[i], false,true);
				}
				else
				document.getElementById('cominfo').salg.options[i]=new Option(salg_name[i],salg_id[i], false, false);
			...
			document.getElementById('cominfo').empstat.options.length=0;
			for (i=0; i<empstat_id.length; i++){
				if( com_info[9] == empstat_name[i])
				{
					document.getElementById('cominfo').empstat.options[i]=new Option(empstat_name[i],empstat_id[i], false,true);
				}
				else
					document.getElementById('cominfo').empstat.options[i]=new Option(empstat_name[i],empstat_id[i], false, false);
			}
			...
			document.getElementById('cominfo').empshift.options.length=0;
			for (i=0; i<empshift_id.length; i++){
				if( com_info[10] == empshift_name[i])
				{
					document.getElementById('cominfo').empshift.options[i]=new Option(empshift_name[i],empshift_id[i], false,true);
				}
				else
				document.getElementById('cominfo').empshift.options[i]=new Option(empshift_name[i],empshift_id[i], false, false);
			...
			//alert(com_info[15]);
			document.getElementById('cominfo').attbonus.options.length=0;
			for (i=0; i<attbonus_id.length; i++){

				if( com_info[15] == attbonus_id[i])
				{
					document.getElementById('cominfo').attbonus.options[i]=new Option(attbonus_name[i],attbonus_id[i], false,true);
				}
				else
					document.getElementById('cominfo').attbonus.options[i]=new Option(attbonus_name[i],attbonus_id[i], false, false);
				}
		...
		document.getElementById('cominfo').transport.options.length=0;
			for (i=0; i<=1; i++){

				if( com_info[13] == otid[i])
				{
					//alert(dept_name[i]);
					document.getElementById('cominfo').transport.options[i]=new Option(otname[i],otid[i], false,true);
				}
				else
				document.getElementById('cominfo').transport.options[i]=new Option(otname[i],otid[i], false, false);
			}




		document.getElementById('cominfo').otentitle.options.length=0;
			for (i=0; i<=1; i++){

				if( com_info[12] == otid[i])
				{
					//alert(dept_name[i]);
					document.getElementById('cominfo').otentitle.options[i]=new Option(otname[i],otid[i], false,true);
				}
				else
				document.getElementById('cominfo').otentitle.options[i]=new Option(otname[i],otid[i], false, false);
			}


			document.getElementById('cominfo').lunch.options.length=0;
			for (i=0; i<=1; i++){

				if( com_info[14] == otid[i])
				{
					//alert(dept_name[i]);
					document.getElementById('cominfo').lunch.options[i]=new Option(otname[i],otid[i], false,true);
				}
				else
				document.getElementById('cominfo').lunch.options[i]=new Option(otname[i],otid[i], false, false);
			}
			...
			document.getElementById('cominfo').saltype.options.length=0;
			for (i=0; i<=1; i++){
				if( com_info[18] == stid[i])
				{
					document.getElementById('cominfo').saltype.options[i]=new Option(stname[i],stid[i], false, true);
				}
				else
				document.getElementById('cominfo').saltype.options[i]=new Option(stname[i],stid[i], false, false);
			}
			...
			document.getElementById('cominfo').saldraw.options.length=0;
			for (i=0; i<=1; i++){
				if( com_info[17] == sdid[i])
				{
					document.getElementById('cominfo').saldraw.options[i]=new Option(sdname[i],sdid[i], false, true);
				}
				else
				document.getElementById('cominfo').saldraw.options[i]=new Option(sdname[i],sdid[i], false, false);
			}
			...
			//alert(unit_name);
			//alert(com_info[20]);
			document.getElementById('cominfo').units.options.length=0;
			for (i=0; i<unit_id.length; i++){
				if( com_info[20] == unit_name[i])
				{
					document.getElementById('cominfo').units.options[i]=new Option(unit_name[i],unit_id[i], false, true);
				}
				else
				document.getElementById('cominfo').units.options[i]=new Option(unit_name[i],unit_id[i], false, false);
			}
			...
			if(com_info[9] == 'Resign')
			{
				...
				document.getElementById('cominfo').pi_edit.disabled = true;
				}
...
function com_info_prev_Search1()
{
	...
	var queryString="id_skill="+id_skill;
	var url = getBaseURL() + "index.php/emp_info_con/com_info_prev_Search1/";
	ajaxRequest.open("POST", url, true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			document.getElementById('emp_last_dg').value = otherinfo[3];
			document.getElementById('pass_year').value = otherinfo[4];
			// document.getElementById('edu_insti').value = otherinfo[5];
			document.getElementById('skill_dept').value = otherinfo[6];
			document.getElementById('skill_year').value = otherinfo[7];
			document.getElementById('skill_com_na').value = otherinfo[8];
			document.getElementById('name').value = otherinfo[9];
			...
			document.getElementById('bname').value = otherinfo[21];
			document.getElementById('id_skill').value = otherinfo[22];
			document.getElementById('spouse_name').value = otherinfo[23];
			document.getElementById('n_id').value = otherinfo[24];
			document.getElementById('bank_ac_no').value = otherinfo[25];
			//document.getElementById('cominfo').search_empid.value = otherinfo[0];
			com_info = alldata[1].split("=*=");
		...
		document.getElementById('cominfo').otentitle.options.length=0;
			...
			document.getElementById('com_transport_allow').value = com_transport_allow;

			document.getElementById('com_lunch_allow').value = com_lunch_allow;

			var com_bsal = Math.round((com_gsal - (com_mallow + com_trans_allow + com_lunch_allow)) / 140 * 100);
			//alert(com_bsal);
			document.getElementById('com_bsal').value = com_bsal;
...
function com_info_Search1(){
	...
	var url =  getBaseURL() + "index.php/emp_info_con/com_info_search1/";
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			com_info = alldata[1].split("=*=");
			// console.log(com_info); return false;
			...
			document.getElementById('cominfo').idcard.value = com_info[1];
            document.getElementById('cominfo').ejd.value = com_info[16];
			...
			// alert(blood_name)
			document.getElementById('cominfo').bgroup.options.length=0;
			for (i=0; i<blood_id.length; i++){
				if( otherinfo[26] == blood_name[i])
				{
				document.getElementById('cominfo').bgroup.options[i]=new Option(blood_name[i],blood_id[i], false, true);
				}else{
				document.getElementById('cominfo').bgroup.options[i]=new Option(blood_name[i],blood_id[i], false, false);
				}
			}
         ...
         document.getElementById('cominfo').emp_sts_id.options.length=0;
         for (i=0; i<sts_id.length; i++){
            if( com_info[28] == sts_id[i])
            {
               document.getElementById('cominfo').emp_sts_id.options[i]=new Option(sts_name[i],sts_id[i], false,true);
            }else{
               document.getElementById('cominfo').emp_sts_id.options[i]=new Option(sts_name[i],sts_id[i], false, false);
            }
         }
			...
			document.getElementById('cominfo').emp_floor.options.length=0;
			for (i=0; i<floor_id.length; i++){
				if( com_info[21] == emp_floor_name[i])
				{
					document.getElementById('cominfo').emp_floor.options[i]=new Option(emp_floor_name[i],floor_id[i], false,true);
				} else {
					document.getElementById('cominfo').emp_floor.options[i]=new Option(emp_floor_name[i],floor_id[i], false, false);
            }
			}
		...
		// ================= LOCAL SALARY (ONLY NON ADMIN) =================
        if (!IS_ADMIN) {

            setValSafe('gsal', com_info[11]);
            var gsal = parseFloat(com_info[11]);

            var d = new Date();
            var curDate = d.toISOString().slice(0, 10);

            var mallow, trans_allow, lunch_allow;
            var com_mallow, com_trans_allow, com_lunch_allow;
            ...
            if (curDate > '2025-02-01') {
                ...
                com_mallow = 750;
                com_trans_allow = 450;
                com_lunch_allow = 1250;
            } else if (curDate > '2023-11-30' && curDate < '2025-02-01') {
                mallow = 750;
                trans_allow = 450;
                lunch_allow = 1250;
            ...
            setValSafe('mallow', mallow);
            setValSafe('transport_allow', trans_allow);
            setValSafe('lunch_allow', lunch_allow);

            var bsal = Math.round((gsal - (mallow + trans_allow + lunch_allow)) / 150 * 100);
            var hrent = Math.round((bsal * 50) / 100);

            setValSafe('bsal', bsal);
            setValSafe('hrent', hrent);
        }
		 // ================= COMPANY CALC (SAFE FOR ALL) =================
        var com_mallow = 750;
        var com_trans_allow = 450;
        var com_lunch_allow = 1250;

        setValSafe('com_mallow', com_mallow);
        setValSafe('com_transport_allow', com_trans_allow);
        setValSafe('com_lunch_allow', com_lunch_allow);

        if (!isNaN(com_gsal)) {
            var com_bsal = Math.round(
                (com_gsal - (com_mallow + com_trans_allow + com_lunch_allow)) / 150 * 100
            );
            var com_hrent = Math.round((com_bsal * 50) / 100);

            setValSafe('com_bsal', com_bsal);
            setValSafe('com_hrent', com_hrent);
        }
			// var d = new Date();
			// var year  = d.getFullYear();
			// var month = d.getMonth()+1;
			...
			// if(curDate > '2025-02-01'){
			// 		var mallow      = 750;
			// 		var trans_allow = 1000;
			// 		var lunch_allow = 1250;
			// 		var com_mallow      = 750;
			// 		var com_trans_allow = 1000;
			// 		var com_lunch_allow = 1250;
			// }else if(curDate > '2023-11-30' && curDate < '2025-02-01'){
			// 		var mallow      = 750;
			// 		var trans_allow = 450;
			...
			// var bsal = Math.round((gsal - (mallow + trans_allow + lunch_allow)) / 150 * 100);
			// var com_bsal = Math.round((com_gsal - (com_mallow + com_trans_allow + com_lunch_allow)) / 150 * 100);
			// document.getElementById('bsal').value = bsal;
			// document.getElementById('com_bsal').value = com_bsal;
...
// 		// alert(otherinfo);
// 		//alert(otherinfo[1]);
// 		document.getElementById('cominfo').empid.value = otherinfo[0];
// 		document.getElementById('cominfo').padd.value = otherinfo[1];
// 		document.getElementById('cominfo').fadd.value = otherinfo[2];
//       document.getElementById('cominfo').emp_last_dg.value = otherinfo[3];
//       document.getElementById('cominfo').pass_year.value = otherinfo[4];
//       document.getElementById('cominfo').edu_insti.value = otherinfo[5];
//       document.getElementById('cominfo').skill_dept.value = otherinfo[6];
//       document.getElementById('cominfo').skill_year.value = otherinfo[7];
//       document.getElementById('cominfo').skill_com_na.value = otherinfo[8];
//       document.getElementById('cominfo').name.value = otherinfo[9];
//       document.getElementById('cominfo').fname.value = otherinfo[10];
//       document.getElementById('cominfo').mname.value = otherinfo[11];
//       document.getElementById('cominfo').mname_bn.value = otherinfo[13];
// 		// alert(otherinfo[11]);
//       document.getElementById('cominfo').fname_bn.value = otherinfo[12];
// 		document.getElementById('cominfo').dob.value = otherinfo[14];
// 		document.getElementById('cominfo').reli.value = otherinfo[15];
// 		document.getElementById('cominfo').sex.value = otherinfo[16];
// 		document.getElementById('cominfo').ms.value = otherinfo[17];
// 		document.getElementById('cominfo').bgroup.value = otherinfo[18];
// 		var img = otherinfo[19];
//       hostname = window.location.href;
//       hostname = hostname.substring(0, (hostname.indexOf("index.php") == -1) ? hostname.length : hostname.indexOf("index.php"));
// 		document.image.src = hostname + "/uploads/photo/"+img;
...
// 		document.getElementById('cominfo').bname.value = otherinfo[20];
// 		document.getElementById('cominfo').id_skill.value = otherinfo[21];
// 		document.getElementById('cominfo').spouse_name.value = otherinfo[22];
//       document.getElementById('cominfo').preadd_bn.value = otherinfo[23];
//       document.getElementById('cominfo').peradd_bn.value = otherinfo[24];
//       document.getElementById('cominfo').nid.value = otherinfo[25];
//       document.getElementById('cominfo').baccnt.value = otherinfo[26];
...
//       document.getElementById('cominfo').sec_bn.options.length=0;
//       for (i=0; i<sec_id.length; i++){
//          if( com_info[24] == sec_name_bn[i])
//          {
//             document.getElementById('cominfo').sec_bn.options[i]=new Option(sec_name_bn[i],sec_id[i], false,true);
//          }
//          else
//             document.getElementById('cominfo').sec_bn.options[i]=new Option(sec_name_bn[i],sec_id[i], false, false);
...
//       document.getElementById('cominfo').desig_bn.options.length=0;
//       for (i=0; i<desig_id_bn.length; i++){
//          if(com_info[23] == desig_name_bn[i])
//          {
//             //alert(dept_name[i]);
//             document.getElementById('cominfo').desig_bn.options[i]=new Option(desig_name_bn[i],desig_id_bn[i], false,true);
//          }
//          else
//          document.getElementById('cominfo').desig_bn.options[i]=new Option(desig_name_bn[i],desig_id_bn[i], false, false);
...
//       document.getElementById('cominfo').working_type.options.length=0;
//       for (i=0; i<wk_id.length; i++){
//          if(com_info[22] == wk_name[i])
//          {
//             //alert(dept_name[i]);
//             document.getElementById('cominfo').working_type.options[i]=new Option(wk_name[i],wk_id[i], false,true);
//          }
//          else
//          document.getElementById('cominfo').working_type.options[i]=new Option(wk_name[i],wk_id[i], false, false);
...
//       document.getElementById('cominfo').empsts.options.length=0;
//       for (i=0; i<empsts_id.length; i++){
//          if( com_info[25] == empsts_name[i])
//          {
//             document.getElementById('cominfo').empsts.options[i]=new Option(empsts_name[i],empsts_id[i], false,true);
//          }
//          else
//          document.getElementById('cominfo').empsts.options[i]=new Option(empsts_name[i],empsts_id[i], false, false);
//       }

//       w_process_id_name = alldata[16].split("===");
//       process_id = w_process_id_name[0].split("***");
//       process_name = w_process_id_name[1].split("***");
//       document.getElementById('cominfo').work_process.options.length=0;
//       for (i=0; i<process_id.length; i++){
//          if( com_info[26] == process_name[i])
//          {
//             document.getElementById('cominfo').work_process.options[i]=new Option(process_name[i],process_id[i], false,true);
//          }
//          else
//          document.getElementById('cominfo').work_process.options[i]=new Option(process_name[i],process_id[i], false, false);
//       }

//       salary_id_name = alldata[17].split("===");
//       salary_id = salary_id_name[0].split("***");
//       salary_name = salary_id_name[1].split("***");
//       document.getElementById('cominfo').ot_define.options.length=0;
//       for (i=0; i<salary_id.length; i++){
//          if( com_info[27] == salary_name[i])
//          {
//             document.getElementById('cominfo').ot_define.options[i]=new Option(salary_name[i],salary_id[i], false,true);
//          }
//          else
//          document.getElementById('cominfo').ot_define.options[i]=new Option(salary_name[i],salary_id[i], false, false);
//       }
...
//       document.getElementById('cominfo').floor_name.options.length=0;
//       for (i=0; i<floor_id.length; i++){
//          if(com_info[21] == floor_name[i])
//          {
//             document.getElementById('cominfo').floor_name.options[i]=new Option(floor_name[i],floor_id[i], false, true);
//          }
//          else
//          document.getElementById('cominfo').floor_name.options[i]=new Option(floor_name[i],floor_id[i], false, false);
//       }
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').idcard.value = companyinfo[1];
...
function com_info_dept(){
 ...
 if(document.getElementById('cominfo').save.disabled == true){
	 return;
	 }
	 else{
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').section.options.length=0;
		document.getElementById('cominfo').section.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<sec_id.length; i++){
			document.getElementById('cominfo').section.options[i+1]=new Option(sec_name[i],sec_id[i], false, false);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').line.options.length=0;
		/*if(dept!=1){
			document.getElementById('cominfo').line.options[0]=new Option("Select","Select", true, false);
		 }*/
		document.getElementById('cominfo').line.options[0]=new Option("Select","Select", true, false);

		for (i=0; i<sec_id.length; i++){
			document.getElementById('cominfo').line.options[i+1]=new Option(sec_name[i],sec_id[i], false, false);
...
function com_info_desig(dept_id){
 ...
 ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').desig.options.length=0;
		document.getElementById('cominfo').desig.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<sec_id.length; i++){
			document.getElementById('cominfo').desig.options[i+1]=new Option(sec_name[i],sec_id[i], false, false);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').salg.options.length=0;
		document.getElementById('cominfo').salg.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<sec_id.length; i++){
			document.getElementById('cominfo').salg.options[i+1]=new Option(sec_name[i],sec_id[i], false, false);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').empstat.options.length=0;
		document.getElementById('cominfo').empstat.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<sec_id.length; i++){
			document.getElementById('cominfo').empstat.options[i+1]=new Option(sec_name[i],sec_id[i], false, false);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').empshift.options.length=0;
		document.getElementById('cominfo').empshift.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<shift_id.length; i++){
			document.getElementById('cominfo').empshift.options[i+1]=new Option(shift_name[i],shift_id[i], false, false);
...
if(empshift=='Select'){
 ...
 if(document.getElementById('cominfo').save.disabled == true){
	 return;
		...
		otid[1] =1;
		document.getElementById('cominfo').otentitle.options.length=0;
		document.getElementById('cominfo').otentitle.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<=1; i++){
			document.getElementById('cominfo').otentitle.options[i+1]=new Option(otname[i],otid[i], false, false);
		}
...
if(otentitle=='Select'){
 ...
 if(document.getElementById('cominfo').save.disabled == true){
	 return;
		...
		otid[1] =1;
		document.getElementById('cominfo').transport.options.length=0;
		document.getElementById('cominfo').transport.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<=1; i++){
			document.getElementById('cominfo').transport.options[i+1]=new Option(otname[i],otid[i], false, false);
		}
...
if(transport=='Select'){
 ...
 if(document.getElementById('cominfo').save.disabled == true){
	 return;
		...
		otid[1] =1;
		document.getElementById('cominfo').lunch.options.length=0;
		document.getElementById('cominfo').lunch.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<=1; i++){
			document.getElementById('cominfo').lunch.options[i+1]=new Option(otname[i],otid[i], false, false);
		}
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').attbonus.options.length=0;
		document.getElementById('cominfo').attbonus.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<ab_id.length; i++){
			document.getElementById('cominfo').attbonus.options[i+1]=new Option(ab_rule_name[i],ab_id[i], false, false);
...
function all_enable_save(){
	document.getElementById('cominfo').pi_save.disabled = false;
	document.getElementById('cominfo').empid.focus();
	//document.getElementById('edu_skill_empid').value="";
}
...
function enable_save(){
	...
	document.image.src ="";
	document.getElementById('cominfo').pi_save.disabled = false;
	document.getElementById('cominfo').empstat.disabled = false;
	document.getElementById('cominfo').pi_edit.disabled = true;
	document.getElementById('cominfo').empid.focus();
}
...
function disable_save(){
	document.getElementById('cominfo').save.disabled = true;
}
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('pi_save').disabled = true;
 		document.getElementById('pi_edit').disabled = false;
 		document.getElementById('empstat').disabled = true;
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('cominfo').dept.options.length=0;
		//document.getElementById('cominfo').dept.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<dept_id.length; i++){
			document.getElementById('cominfo').dept.options[i]=new Option(dept_name[i],dept_id[i], false, false);
		...
		document.getElementById('cominfo').sec.options.length=0;
		//document.getElementById('cominfo').sec.options[0]=new Option("Select","Select", true, false);
		for (i=0; i<sec_id.length; i++){
			//alert(sec_name[i]);
			document.getElementById('cominfo').sec.options[i]=new Option(sec_name[i],sec_id[i], false, false);
